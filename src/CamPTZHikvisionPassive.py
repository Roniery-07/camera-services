...
class CamPTZHikvisionPassive(CamBaseFixa):
    ...
    def run(self):
        ...
        while True:
            ...
            analyzed_frames_wbbox.append(frame.copy())
            ...
            if (detection_count/qt_analyzed_frames) >= camera["perc_frames_para_mp4"]:
                ...
                self.save_all_analyzed_video(metadados, analyzed_frames, analyzed_frames_wbbox)
