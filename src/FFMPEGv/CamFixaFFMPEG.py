   ...
   def run(self):
        ...
        while not self.stop_event.is_set():
            ...
            if agora_monotonic < deadline:
                ...
                deadline = time.monotonic() + duracaoconfirmacao # Reset deadline for confirmation
                emconfirmacao = True
                detection_count_confirmacao = 0
                analyzed_frames_confirmacao = 0
                continue
            ...
            if emconfirmacao:
                ...
                dados = [None, qt_analyzed_frames, qt_analyzed_frames_busca, 
                         analyzed_frames_confirmacao, detection_count, 
                         qt_detection_count_busca, detection_count_confirmacao]
