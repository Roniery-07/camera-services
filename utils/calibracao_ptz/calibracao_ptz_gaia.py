...
def ptz_tracking(
    w, h, a, b, c,
    pmin, pmax, tmin, tmax, z, zmax, eta=3, alpha=None
):
    ...
    dz = math.log(1 + max(min(w/eta/a, h/eta/b, zmax**(1-z)), zmax**(-z)) / (zmax**z)) / math.log(zmax)
...
def move_camera_to_track_object(bbox, ptzc, eta=3):
    ...
    dp, dt, dz = ptz_tracking(w, h, a, b, c,
        pmin, pmax, tmin, tmax, z, zmax, eta, alpha)
